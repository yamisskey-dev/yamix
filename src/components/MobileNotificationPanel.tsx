...
export function MobileNotificationPanel({
  ...
  return createPortal(
    ...
    >
      ...
      <div
        className={`absolute bottom-0 left-0 right-0 max-h-[70vh] bg-base-100 rounded-t-2xl shadow-xl transition-transform duration-300 ease-out flex flex-col ${
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-2 border-b border-base-300">
          <span className="font-bold text-base">通知</span>
        ...
        <div className="overflow-y-auto flex-1 pb-safe">
          {loading ? (
            <div className="flex items-center justify-center p-8">
              <img src="/static/loading/1.gif" alt="読み込み中" className="w-8 h-8" />
            </div>
